...
// en vivo de cómo se ve para mentores/empresas. Adaptado del Stitch a nuestra
// marca y conectado a la fuente única (perfil). Foto real desde el perfil.
      ...
      <div className="mx-auto max-w-[1280px] p-8">
        ...
        <div className="grid grid-cols-1 items-start gap-6 xl:grid-cols-12">
          ...
          <div className="flex flex-col gap-6 xl:col-span-7">
            <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-6 shadow-[0_12px_32px_-14px_rgba(0,40,55,0.15)] sm:p-8">
              <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  onClick={() => notificar('✅ Cambios guardados')}
                  className="rounded-lg bg-gradient-to-r from-primary to-secondary px-5 py-2 text-sm font-bold text-on-primary shadow-md transition-transform hover:-translate-y-0.5"
                >
                  Guardar cambios
                </button>
              </div>
          ...
          <div className="xl:col-span-5 xl:sticky xl:top-24">
            <div className="overflow-hidden rounded-2xl border border-outline-variant bg-surface-container-lowest shadow-[0_12px_32px_-14px_rgba(0,40,55,0.15)]">
