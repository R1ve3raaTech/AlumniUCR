...
// Configuración (exalumno). Espejo del diseño de /configuracion del estudiante:
// mismas tarjetas Seccion/Fila, Apariencia (modo oscuro con lib/useTema) e
// Idioma. Los datos del perfil se editan en /perfil-exalumno (fuente real);
// aquí solo se enlaza, para no duplicar formularios.
...
export default function ConfiguracionExalumnoPage() {
      ...
      <main className="pt-16">
        <div className="mx-auto flex max-w-[900px] flex-col gap-6 p-8">
          ...
          <Seccion titulo="Datos Personales" icono="badge">
            <Fila
              titulo="Perfil de exalumno"
              descripcion="Nombre, biografía, trayectoria, áreas y tipo de apoyo se editan en tu perfil."
              accion={<Link href="/perfil-exalumno" className={botonSecundario}>Editar perfil</Link>}
            />
            <Fila
