...
// Mi currículum (CV del estudiante) — EN RECONSTRUCCIÓN. Se rehará con Stitch.
...
export default function MiCurriculumPage() {
  return (
    <main className="grid min-h-screen place-items-center bg-ucr-surface p-8 text-center font-brand-body text-ucr-on-surface">
      <div>
        <p className="font-ucr-display text-2xl font-bold text-ucr-primary">Mi currículum</p>
