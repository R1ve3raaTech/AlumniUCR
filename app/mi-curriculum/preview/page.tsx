...
// Vista previa del CV — EN RECONSTRUCCIÓN. Se rehará desde cero con Stitch.
...
export default function PreviewCvPage() {
  return (
    <main className="grid min-h-screen place-items-center bg-ucr-surface p-8 text-center font-brand-body text-ucr-on-surface">
      <div>
        <p className="font-ucr-display text-2xl font-bold text-ucr-primary">Vista previa del CV</p>
