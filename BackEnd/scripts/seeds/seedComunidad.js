 ...
 *
 * Uso:  node scripts/seedComunidad.js   (desde la carpeta BackEnd/)
 * Requiere SUPABASE_SECRET_KEY (service_role) en BackEnd/.env.local y haber corrido
 * BackEnd/db/schema/blogs_eventos.sql en Supabase.
 */
