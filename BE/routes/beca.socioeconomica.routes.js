...
router.get('/buscar', autenticarUsuario, exigirRol('admin'), becaSocioeconomicaController.buscarBecaPorNombre);
router.get('/', autenticarUsuario, exigirRol('admin'), becaSocioeconomicaController.obtenerBecasSocioeconomicas);
router.get('/:id', autenticarUsuario, exigirRol('admin'), becaSocioeconomicaController.obtenerBecaSocioeconomicaPorId);
